...
/**
 * <b>菠菜侠旅游租赁平台-大巴车订单管理-大巴车订单退款实体信息</b>
 * @author Arthur
 * @version 1.0.0
 * @since 1.0.0
 */
public class OrderRefundRecord extends BaseEntity {
	private static final long serialVersionUID = 8766789373511415492L;
	 ...
	 * @return
	 */
	public static OrderRefundRecord parseFromEntity(OrderRefundRecordVO vo) {
		// 创建实体对象
		OrderRefundRecord entity = new OrderRefundRecord();
		// 进行普通属性切换
